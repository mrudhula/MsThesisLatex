...
OGRE is more than just a rendering engine, despite what name implies. Among all the features, the ones utilized considerably in the software are as follows~\cite{Knot2012}.
