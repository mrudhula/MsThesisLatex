...
\begin{figure}[h]
\centerline{\fbox{\psfig{figure=figures/kinect_depth_output_comparison.eps,width=1.00\textwidth}}}
...
\begin{figure}[h]
\centerline{\fbox{\psfig{figure=figures/nite_joints.eps,width=0.90\textwidth}}}
